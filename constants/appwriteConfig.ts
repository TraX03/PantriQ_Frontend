...
export const AppwriteConfig = {
  ...
  COMMUNITIES_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_COMMUNITIES_COLLECTION_ID!,
  RECIPES_COLLECTION_ID: process.env.EXPO_PUBLIC_APPWRITE_RECIPES_COLLECTION_ID!,
};
